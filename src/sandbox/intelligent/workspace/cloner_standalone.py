"""
Standalone implementation of workspace cloning functionality.
This version works without relative imports for testing purposes.
"""
...
class WorkspaceClonerInterface(ABC):
    ...
    def setup_isolation(self, workspace: SandboxWorkspace) -> bool:
        """Set up isolation for the workspace."""
        pass
...
# Simple security policy for standalone version
@dataclass
class SimpleSecurityPolicy:
    """Simplified security policy for standalone testing."""
...
class WorkspaceCloner(WorkspaceClonerInterface):
    ...
    def __init__(self):
        ...
        self._security_policy = SimpleSecurityPolicy()
